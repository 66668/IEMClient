...
import com.xiaolin.wheel.wheelviewListener.OnWheelChangedListener;
import com.xiaolin.wheel.wheelviewListener.OnWheelScrollListener;
import com.xiaolin.wheel.wheelviewadapter.AbstractWheelTextAdapter;
import com.xiaolin.wheel.wheelwidget.WheelView;
...
//                mDateCalendarTextView.setText(" " + arry_date.get(wheel.getCurrentItem()));
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter {
        ...
        protected CalendarTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
            super(context, R.layout.item_wheelview_textview, R.id.tempValue, currentItem, maxsize, minsize);
            this.list = list;
        }
