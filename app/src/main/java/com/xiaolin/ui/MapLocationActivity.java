...
public class MapLocationActivity extends BaseActivity implements LocationSource, ILocationView {
    ...
    private boolean isEmpoty() {
        if (TextUtils.isEmpty(currentTime)) {
            DebugUtil.ToastShort(MapLocationActivity.this, "没有获取时间");
            return true;
        }
        if (TextUtils.isEmpty(address)) {
            DebugUtil.ToastShort(MapLocationActivity.this, "没有获取到地址");
            return true;
        }
        return false;
    }
    ...
    private void location() {
        ...
        mLocationOption.setMockEnable(true);//false true
