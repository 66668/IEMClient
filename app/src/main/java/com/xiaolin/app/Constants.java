...
public class Constants {
    ...
    public static String TODAY_DATE = "TodayDate";    // 缓存 yyyy-MM-dd
    public static String YESTODY_DATE = "YesterdayState";    // 缓存 yyyy-MM-dd
    public static String DEVICEID = "DeviceId";
    public static String FIRSTATTEND = "FirstAttend";//hh:mm:ss
    public static String LASTATTEND = "LastAttend";//hh:mm:ss
